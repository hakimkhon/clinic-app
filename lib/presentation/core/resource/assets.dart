...
class ImageAssets {
  static const String topRightImage = "$imagePath/top_right_image.svg";
  static const String bottomLeftImage = "$imagePath/bottom_left_image.svg";
  static const String topLeftImage = "$imagePath/top_left_image.svg";
  static const String bottomRightImage = "$imagePath/bottom_right_image.svg";
}
...
class IconsAssets {
  static const String clinic = "$iconPath/clinic_icon.png";
  static const String logoApp = "$imagePath/logo_app.png";
}

class LangAssets {
  static String changData = "edit_data".tr();
  static String changLang = "edit_lang".tr();
  static String phoneNum = "phone_num".tr();
  ...
  static String sendSms = "send_sms".tr();
  static String sendCod = "send_kod".tr();
  static String sendEter = "send_enter".tr();
  static String langEn = "lang_en".tr();
  static String langRu = "lang_ru".tr();
  static String langUz = "lang_uz".tr();
  static String offerta = "offerta".tr();
...
class AppFonts {
  static const String lexendTera = "LexendTera";
